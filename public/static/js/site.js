                        ...
                        div += "<div class=\"image\">";
                            div += "<div class=\"overlay\">";
                                div += "<div class=\"btns\">";
                                    ...
                                    div += "<a href=\"#\"><i class=\"fa-solid fa-cart-arrow-down\"></i></a>";
                                    if(auth =="1"){                                 
                                        div += "<a href=\"#\" id=\"favorite_1_"+product.id+"\" onclick=\"add_to_favorites('"+product.id+"', '1'); return false;\"><i class=\"fa-solid fa-heart\"></i></a>";
                                    }else {
                                    div += "<a href=\"#\" id=\"favorite_1_"+product.id+"\" onclick=\"Swal.fire({position: 'top-end',icon: 'warning', title: 'Ingrese a su cuenta', showConfirmButton: false, timer: 1000}); return false;\"><i class=\"fa-solid fa-heart\"></i></a>";
                                    }   
                                div += "</div>";
                            div += "</div>";                          
                            div += "<img class=\"img-fluid\" src=\""+base+"/uploads/"+product_image.path+"/500x500_"+product_image.final_name+"\" alt=\""+product.name+"\">";                
                        div +="</div>";
...
function load_product_variants(inventory_id){
    ...
    loader.style.display = 'flex';
    for(i=0;i< inventory.length; i++){
        inventory[i].classList.remove('active');
    }
